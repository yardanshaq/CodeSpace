...
export default function LoaderContent({ timedOut = false }: { timedOut?: boolean }) {
  return (
    <>
      <img
        ...
        style={{
          borderRadius: 12,
          display: "block",
          animation: "cs-logo-entrance 1.5s ease-in-out infinite",
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
          ...
          <button
            ...
            style={{
              ...
              background: "var(--teal, #4ecdc4)", color: "#000",
              cursor: "pointer",
